...
R package **piamValidation**, version **0.2.13**
...
Weigmann P, Richters O (2024). _piamValidation: Validation Tools for PIK-PIAM_. R package version 0.2.13, <https://github.com/pik-piam/piamValidation>.
