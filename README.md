...
R package **piamValidation**, version **0.1.2**
...
Weigmann P, Richters O (2024). _piamValidation: Validation Tools for PIK-PIAM_. R package version 0.1.2, <URL: https://github.com/pik-piam/piamValidation>.
